...
export const MODULE_CATALOG: CatalogModule[] = [
  ...
  {
    key: "campo-drench-products",
    label: "Administrar productos Drench",
    title: "Administrar productos Drench",
    eyebrow: "Gestion / Campo / Administrar Maestros",
    summary: "Maestro transaccional de productos Drench para reemplazar la hoja CODIGOS D dentro del sistema.",
    href: "/dashboard/campo/administrar-maestros/productos-drench",
    icon: DatabaseZap,
    navigationGroup: "Gestion",
