...
export const MODULE_CATALOG: CatalogModule[] = [
  ...
  {
    key: "calidad-temperatura-invernaderos",
    label: "Temperatura invernaderos",
    title: "Temperatura invernaderos",
    eyebrow: "Gestion / Calidad / Registros",
    summary: "Ruta reservada para registros de temperatura en invernaderos dentro del dominio de calidad.",
    href: "/dashboard/calidad/registros/temperatura-invernaderos",
    icon: ClipboardList,
    navigationGroup: "Gestion",
    trail: ["Calidad", "Registros"],
    accessSection: "Gestion",
    status: "active",
    mobileVisible: false,
  },
