...
export const MODULE_CATALOG: CatalogModule[] = [
  ...
  {
    key: "campo-alturas-dron",
    label: "Alturas Dron",
    title: "Alturas Dron (CHN)",
    eyebrow: "Analítica / Campo / Análisis",
    summary: "Altura normalizada del cultivo por bloque y fecha, derivada de mediciones dron (CHN).",
    href: "/dashboard/campo/alturas-dron",
    icon: Plane,
    navigationGroup: "Dashboard",
    trail: ["Campo", "Análisis"],
    accessSection: "Analítica / Análisis",
  ...
  },
  {
    ...
    label: "Productividad",
    title: "Productividad de Postcosecha",
    eyebrow: "Analítica / Postcosecha / Indicadores & KPI",
    summary: "Horas por caja (H/Caja) por CLS/SB/EMP, camino, destino y semana.",
  ...
  {
    key: "comercial-reclamos-analytics",
    label: "Reclamos",
    title: "Reclamos",
    eyebrow: "Analitica / Comercial / Indicadores & KPI / Reclamos",
    summary: "Visualizador consolidado de reclamos de calidad y comercial, con filtros por alcance, estados, naturaleza y tipo de problema.",
    href: "/dashboard/comercial/indicadores-kpi/reclamos",
    icon: Activity,
    navigationGroup: "Dashboard",
    trail: ["Comercial", "Indicadores & KPI"],
    accessSection: "Analítica / Indicadores & KPI",
    status: "active",
    mobileVisible: false,
  },
  ...
  {
    key: "general-punto-apertura",
    label: "Punto de apertura",
    title: "Punto de apertura",
    eyebrow: "Administración / Maestros por dominio / General / Punto de apertura",
    summary: "Catalogo oficial de categorias de punto de apertura para Calidad y reglas operativas.",
    href: "/dashboard/general/administrar-maestros/punto-apertura",
    icon: Target,
    navigationGroup: "Administracion",
    trail: ["Maestros por dominio", "General"],
    accessSection: "Administracion",
  ...
  {
    key: "general-punto-apertura-rules",
    label: "Punto de apertura",
    title: "Punto de apertura",
    eyebrow: "Gestión / General / Reglas operativas",
    summary: "Registro del criterio objetivo vigente para comparar la medición de punto de apertura y luego construir KPIs de cumplimiento.",
    href: "/dashboard/general/reglas-operativas/punto-apertura",
    icon: Target,
    navigationGroup: "Gestion",
